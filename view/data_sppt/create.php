    ...
    <div class="layout-container">
        ...
        <div class="content-wrapper">
            ...
            <div class="container flex-grow-1 container-p-y">
                <div class="mt-3 mb-5">
                    <h4 class="fw-bold"><span class="text-muted fw-light">Tambah </span>Data SPPT</h4>
                    <p class="text-secondary">Tambah Data Surat Pemberitahuan Pajak Terhutang.</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="../data_sppt/create.php?id=<?= $id; ?>" method="post">
                                    <input type="hidden" name="user_id" value="<?= $query['id']; ?>">
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="kode_id">Kode_id</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="kode_id" name="kode_id" placeholder="Masukkan Kode ID..."/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="nop">NOP</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="nop" name="nop" placeholder="Masukkan Nomor Objek Pajak Anda..."/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="akun">Akun</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="akun" name="akun" placeholder="Masukkan Akun Anda..."/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="alamat_op" name="alamat_op" placeholder="Masukkan Alamat OP Anda..."/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="alamat_wp" name="alamat_wp" placeholder="Masukkan Alamat WP Anda..."/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="luas_bumi" name="luas_bumi" placeholder="Masukkan Luas Bumi Anda..."/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="kelas_bumi" name="kelas_bumi" placeholder="Masukkan Kelas Bumi Anda..."/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="njop_bumi" name="njop_bumi" placeholder="Masukkan NJOP Bumi Anda..."/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="luas_bangunan" name="luas_bangunan" placeholder="Masukkan Luas Bangunan Anda..."/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="kelas_bangunan" name="kelas_bangunan" placeholder="Masukkan Kelas Bangunan Anda..."/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="njop_bangunan" name="njop_bangunan" placeholder="Masukkan NJOP Bangunan Anda..."/>
